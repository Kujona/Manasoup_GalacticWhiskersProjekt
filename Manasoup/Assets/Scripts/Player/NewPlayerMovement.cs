...
public class NewPlayerMovement : MonoBehaviour
{
    ...
    public void Respawn()
    {
        rb.transform.position = new Vector3(0, 0, -6); //Spieler Sawned wieder bei 0,0. Die Level m�ssen einfach so gebaut werden, dass der Spawnpunkt bei diesen Weltkoordinaten ist.
    }
}
